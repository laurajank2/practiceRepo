...
class TaskListPage {
  constructor() {
    ...
    firebase.database().ref("priorities").once("value", (prioritiesSnapshot) => { 
      console.log(prioritiesSnapshot.val())
    });
    ...
    firebase.database().ref("priorities").once("value", (prioritiesSnapshot) => {
      ...
      .once("value", (snapshot) => {
        ...
        Object.keys(allTasks).forEach((taskId) => {
          ...
          if (taskData.userId == firebase.auth().currentUser.uid) {
...
document.getElementById("registerBtn").addEventListener("click", (e) => {
  ...
  const emailTitle = emailElement.value;

  const passwordElement = document.getElementById("password");
  const passwordTitle = passwordElement.value;

  const registerPage = new RegisterPage(emailTitle, passwordTitle);
});
...
document.getElementById("logInBtn").addEventListener("click", (e) => {
  ...
  const logInPage = new LogInPage(emailTitle, passwordTitle);
...
document.getElementById("logInPageBtn").addEventListener("click", (e) => {
  document.getElementById("taskListPage").style.display = "none";
  document.getElementById("registerPage").style.display = "none";
  document.getElementById("logInPage").style.display = "block";
  document.getElementById("welcomePage").style.display = "none";
...
document.getElementById("registerPageBtn").addEventListener("click", (e) => {
  document.getElementById("taskListPage").style.display = "none";
